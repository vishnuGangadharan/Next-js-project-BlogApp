...
const CardOne = () => {
  return (
    <div className="min-h-full bg-black text-white md:px-24 md:pt-16 md:pb-20 ">
  <Card className="bg-black font-inter md:flex border-none ">
    ...
    <div className="p-10 w-full">
      ...
      <div className="flex justify-between">
        ...
        <Button  style={{ backgroundColor: "#1A1A1A" }} className="text-white font-inter">Read More</Button>
      </div> 
    </div>
  </Card>

  <div className="mt-16 flex flex-wrap justify-between gap-8 ">
    <Card className="w-full sm:w-[350px] bg-black border-none px-4 md:px-0">
      <Image
        src="/card1.png"
        alt=""
